...
$(document).ready(function () {
  ...
  $.ajax({
    ...
    success: function success(data) {
      console.log(data); // valore dell oggetto dell api è un array
      //
      ...
      for (var i = 0; i < arrayCd.length; i++) {
        ...
        var singoloCd = arrayCd[i]; // console.log(singoloCd);
        ...
        var htmlGenerato = template(singoloCd); // appnedo al container il singolo cd generato con l html
...
__webpack_require__(/*! C:\MAMP\htdocs\repo-PHP\php-ajax-dischi\src\app.js */"./src/app.js");
module.exports = __webpack_require__(/*! C:\MAMP\htdocs\repo-PHP\php-ajax-dischi\src\app.scss */"./src/app.scss");
